...
const BLOG = {
  AUTHOR: '竟何', // 作者
  BIO: '写给你的长信', // 作者简介
  LINK: 'https://videos.lylelove.top', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || '7883cb97a88d4fc285aefa81e6858b92', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: 'lylelove@163.com',
  CONTACT_WEIBO: 'https://weibo.com/u/7193339064',
  CONTACT_TWITTER: 'https://twitter.com/_lyle__',
  CONTACT_GITHUB: 'https://github.com/lylelove',
  CONTACT_TELEGRAM: 'https://t.me/lylelove',
  ...
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'lylelove/message', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  COMMENT_GISCUS_REPO_ID: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO_ID || 'R_kgDOG1f3LA', // 你的Github Repo ID e.g ( 設定完 giscus 即可看到 )
  COMMENT_GISCUS_CATEGORY_ID:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID || 'DIC_kwDOG1f3LM4CPM2f', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )
  ...
  COMMENT_WALINE_SERVER_URL: process.env.NEXT_PUBLIC_WALINE_SERVER_URL || 'https://messages.lylelove.top/', // Waline 评论 @see https://waline.js.org/guide/get-started.html
